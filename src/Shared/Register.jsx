      ...
      <div className="  hero  min-h-screen bg-base-200"  style={{backgroundImage: `url(https://img.freepik.com/free-photo/abstract-digital-grid-black-background_53876-97647.jpg?size=626&ext=jpg&ga=GA1.1.1224184972.1715385600&semt=ais_user)`}}>
        ...
        {errors.password && <span className="text-red-500">This field is required</span>}
              ...
              <div className="form-control mt-6 p-0">
                <button type="submit" className="btn  bg-gray-800 border-2 text-white text-xl shadow-xl ">Register</button>
              </div>
              <label className="label text-lg">
                Have an account?{" "}
                <Link to="/login" className="label-text-alt  link link-hover  text-lg  rounded-xl p-2 glass">
                  Please Login
                </Link>
              </label>
              <SocialLogin />
