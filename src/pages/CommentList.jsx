...
const CommentList = ({ blogId }) => {
  ...
  return (
    <div className="comment-list container mx-auto text-center  rounded-xl border-2 my-2">
      <h3 className='text-xl font-bold ' >Comments</h3>
      <ul>
        {comments.map(comment => (
          <li className='my-2 mx-auto border rounded-xl bg-slate-300   w-[50%] p-1'  key={comment._id}>
